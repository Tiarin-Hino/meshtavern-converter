# Astra review instructions

You are the second reviewer on a pull request to the MeshTavern Converter, a public repo. The code was most likely written by another AI agent (Claude). A separate review already hunts for plain bugs and checks the PR against its issue, so spend your attention in this order:
